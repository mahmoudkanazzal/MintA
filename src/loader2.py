...
#             print("node_type is ")
#             print(node_type, "\n")
#             print("xxxxxxxxxxxx edge_type")
#             print(edge_type, "\n")

#             print("zzzzzz edge_data")
#             print(edge_data, "\n")
#             print("shape of x")
# #             print(x, "\n")
    ...
    def get_edge_map(data):
        if 'edge_map' in data:
            return [(
                ...
                (data.node_type == edge_node_types[2]).nonzero().view(1, -1).cpu().numpy()[0]
